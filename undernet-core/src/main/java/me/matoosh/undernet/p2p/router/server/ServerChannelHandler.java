...
public class ServerChannelHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelActive(ChannelHandlerContext ctx) throws Exception {
        ...
        otherNode.address = ctx.channel().remoteAddress(); //Setting the node's address.
        otherNode.router = server.router; //Setting the router reference on the node.
        ctx.channel().attr(ATTRIBUTE_KEY_CLIENT_NODE).set(otherNode);
    }
